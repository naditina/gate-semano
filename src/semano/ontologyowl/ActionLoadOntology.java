 ...
 *
 *  $Id: ActionLoadOntology.java 11598 2009-10-13 13:44:17Z johann_p $
 */
...
class ActionLoadOntology
    ...
    private AbstractOWLOntology ontology;

    public ActionLoadOntology(String label, AbstractOWLOntology aThis) {
        super(label);
        ontology = aThis;
    }
