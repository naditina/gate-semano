 ...
 *
 *  $Id: OntologyUtilities.java 11600 2009-10-13 17:13:22Z johann_p $
 */
...
import gate.creole.ontology.OConstants.XMLSchema;
...
public class OntologyUtilities {
    ...
    public static final String NON_NEGATIVE_INTEGER = XMLSchema.NON_NEGATIVE_INTEGER.toString();
    public static final String LABEL = RDFS.LABEL.toString();
    public static final String COMMENT = RDFS.COMMENT.toString();
    public static final String HASVALUE = OWL.HASVALUE.toString();
    public static final String ALLVALUESFROM = OWL.ALLVALUESFROM.toString();
    public static final String SOMEVALUESFROM = OWL.SOMEVALUESFROM.toString();
    public static final String CARDINALITY = OWL.CARDINALITY.toString();
    public static final String MINCARDINALITY = OWL.MINCARDINALITY.toString();
    public static final String MAXCARDINALITY = OWL.MAXCARDINALITY.toString();
        ...
        try {
            ...
            if (ontology == null) {
                ...
                ontology = (Ontology) Factory.createResource(
                        "kit.aifb.ontologyowl.OntologyResource", params);
            }
        } catch (Exception e) {
    ...
    static {
        ...
        datatypeMap.put("http://www.w3.org/2001/XMLSchema#string", DataType
                .getStringDataType());
        datatypeMap.put("http://www.w3.org/2001/XMLSchema#anyURI", DataType
                .getStringDataType());
